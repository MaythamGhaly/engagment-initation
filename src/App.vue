...
.heartz {
  ...
  /* Aligns it vertically with text */
  /* height: 1em; */
  /* Makes the image roughly the size of the text */
  display: inline-block;
  /* Ensures it's treated as inline content */
  margin-left: 5px;
  /* Adds a small space before the heart */
}
